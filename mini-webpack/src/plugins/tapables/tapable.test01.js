...
class Lesson {
  constructor() {
    // 初始化钩子容器
    this.hooks = {
      syncHook: new SyncHook(['syncHook address']),
      syncBailHook: new SyncBailHook(['syncBailHook address2'])
    };
  ...
  initTap() {
    ...
    // syncBailHook：往hooks容器中注册事件/添加回调函数
