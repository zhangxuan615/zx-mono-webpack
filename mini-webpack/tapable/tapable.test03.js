...
class Lesson {
  ...
  initTap() {
    this.hooks.asyncSeriesHook.tapPromise('asyncHook03', (name, age) => {
    ...
    // syncHook
    this.hooks.asyncSeriesHook.tapAsync('asyncHook01', (name, age, cb) => {
    ...
    this.hooks.asyncSeriesHook.tapAsync('asyncHook02', (name, age, cb) => {
      console.log('asyncHook log 02: ', name, age);
      cb();
    });
  }

  startAsyncSeriesHook() {
    this.hooks.asyncSeriesHook.callAsync('zx1', 18, () => {
